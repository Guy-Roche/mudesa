                                ...
                                <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                    ...
                                    <div class="pt-0">
                                        ...
                                        <div class="text-center text-muted">
                                            <p class="mb-0">Changer d'avis ?<a class='text-primary ms-2 fw-medium' href='auth-login.html'>Retour à la connexion</a></p>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-7">
                        <div class="account-page-bg p-md-5 p-4">
                            <div class="text-center">
                                <h3 class="text-dark mb-3 pera-title">Veuillez réinitialiser votre mot de passe</h3>
