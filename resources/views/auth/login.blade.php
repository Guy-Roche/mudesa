                                    ...
                                    <form action="{{ route('login') }}" method="POST" class="my-4">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" type="email" id="emailaddress" name="email"
                                                required="" placeholder="Entrez votre e-mail">
                                            @error('email')
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="checkbox-signin"
                                                        checked>
                                                    <label class="form-check-label" for="checkbox-signin">Rappeler
                                                        moi</label>
                                                </div>
                                            </div>
                ...
                <div class="col-xl-7">
                    <div class="account-page-bg p-md-5 p-4">
                        <div class="text-center">
                            <h3 class="text-dark mb-3 pera-title">Veuillez vous connecter pour accéder à
                                l'administration</h3>
